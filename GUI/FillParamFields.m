%%
    function [DATA, GUI, param_keys_length, max_extent_control, handles_boxes] = FillParamFields(DATA, GUI, myColors, VBoxHandle, param_map)
        ...
        for i = 1 : param_keys_length
            ...
            HBox = uix.HBox( 'Parent', VBoxHandle, 'Spacing', DATA.Spacing, 'BackgroundColor', myColors.myUpBackgroundColor);
