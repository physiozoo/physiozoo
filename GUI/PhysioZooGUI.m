...
%         jTreeFig.setIcon(figIcon);
        ...
        GUI.OptionsBox = uix.VBox( 'Parent', GUI.OptionsTab, 'Spacing', 5);
...
%         end
        ...
        uicontrol( 'Style', 'text', 'Parent', GUI.FilteringParamBox, 'String', 'Range Filtering', 'FontSize', SmallFontSize, 'HorizontalAlignment', 'left', 'FontWeight', 'Bold');  
        ...
        uicontrol( 'Style', 'text', 'Parent', GUI.FilteringParamBox, 'String', 'Lowpass Filtering', 'FontSize', SmallFontSize, 'HorizontalAlignment', 'left', 'FontWeight', 'Bold');
        ...
        uicontrol( 'Style', 'text', 'Parent', GUI.FilteringParamBox, 'String', 'Quotient Filtering', 'FontSize', SmallFontSize, 'HorizontalAlignment', 'left', 'FontWeight', 'Bold');
...
%         set( DefaultMethodBox, 'Widths', [-37, -24, -17]  );                        
        ...
        uicontrol( 'Style', 'text', 'Parent', GUI.NonLinearParamBox, 'String', 'DFA', 'FontSize', SmallFontSize, 'HorizontalAlignment', 'left', 'FontWeight', 'Bold');   
        ...
        uicontrol( 'Style', 'text', 'Parent', GUI.NonLinearParamBox, 'String', 'MSE', 'FontSize', SmallFontSize, 'HorizontalAlignment', 'left', 'FontWeight', 'Bold'); 
...
%%
    function filt_slider_Callback(~, ~)
        ...
        %[DATA.tnn_window, DATA.nni_window] = getFilteredSignal();
        CalcPlotSignalStat();
    end
%%
...
%                 clear_statistics_plots();
%                 clearStatTables();
%                errordlg(['Reset error: ' e.message], 'Input Error');
            end
        end
    end % reset
...
%%
    function update_statistics(param_category)
        if strcmp(param_category, 'filtrr') % || strcmp(param_category(1), 'poincare')
            FiltSignal();
            CalcPlotSignalStat();
...
%             value = methods_str{index_selected};
            ...
            elseif strcmp(param_name, 'hrv_freq.window_minutes')
                if isnan(screen_value) || screen_value > DATA.maxSignalLength/60 || screen_value < 0.5
                    errordlg(['set_config_Callback error: ' 'The value must be greater than 30 sec and less than data length!'], 'Input Error');
                    set(src, 'String', prev_screen_value);
                    return;
                end
