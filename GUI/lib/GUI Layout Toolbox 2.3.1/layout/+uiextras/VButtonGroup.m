classdef VButtonGroup < uiextras.VButtonBox & uiextras.ButtonGroup
    %VButtonGroup Create container object to exclusively manage radio
    %buttons and toggle buttons in a vertical row
    %
    % VButtonGroup requires the GUI Layout Toolbox by Ben Tordoff and David
    ...
    %
    % The uiextras.VButtonGroup should be placed in the +uiextras folder in
    ...
    %
    % See also uiextras.HButtonGroup
    
  
%% Constructor    
    methods
        function obj = VButtonGroup(varargin)
            obj = obj@uiextras.VButtonBox(varargin{:});
